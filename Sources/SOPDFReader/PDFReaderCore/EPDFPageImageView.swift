...
class EPDFPageImageView: UIView {
    ...
    override func layoutSubviews() {
        ...
        case .left:
            constraints.append(contentsOf: NSLayoutConstraint.constraints(withVisualFormat: "H:|[view]", options: [], metrics: nil, views: ["view": self.imageView as Any]))
        case .right:
            constraints.append(contentsOf: NSLayoutConstraint.constraints(withVisualFormat: "H:[view]|", options: [], metrics: nil, views: ["view": self.imageView as Any]))
        }
        ...
        constraints.append(NSLayoutConstraint(item: self.imageView as Any, attribute: .width, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: displaySize.width))
        constraints.append(NSLayoutConstraint(item: self.imageView as Any, attribute: .height, relatedBy: .equal, toItem: nil, attribute: .notAnAttribute, multiplier: 1.0, constant: displaySize.height))
